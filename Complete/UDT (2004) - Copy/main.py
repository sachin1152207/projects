			...
			try:
				...
				if log['status_code'] == 200:
					...
					if log['status_code'] == 200:
						...
						log = json.loads(requests.get('http://localhost:5000/auth?username='+ email +'&password='+ pass3).text)
						if log['status_code'] == 200:
